...
- Changed-file Ultracite checks and Git whitespace checks passed. The initial complete-repository check reported existing formatting/research lint findings. After integrating main's fixes from `7205814`, the full repository check, workspace typechecking and workspace tests all passed.
