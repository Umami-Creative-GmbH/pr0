...
If CONTEXT-MAP.md exists after a future migration, follow its pointers
to the relevant context documents and scoped ADRs.
...
When a needed concept is missing, check existing terminology before
identifying a gap for domain-modeling.

If a proposal contradicts an ADR, identify the decision and explain
