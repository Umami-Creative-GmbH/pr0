...
For the agreed product behavior, canonical decisions and approved implementation readiness, see the [MVP specification handoff](docs/specs/mvp-readiness.md).
