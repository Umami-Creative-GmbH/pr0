...
export const promptPaths = {
  "/api/v1/library/organization": {
    get: {
      ...
      description:
        "Complete library snapshot, including unused collections, bounded at 200 entries. Active, archived and total counts describe this snapshot independently of prompt views. Alphabetical ordering uses pr0-search-v1-ucd17 scalar order with UUID ties. No query parameters. Names and counts are returned in a single serialized read at the reported revision.",
      responses: {
        "200": response(
          "OrganizationSnapshot",
          "All collections, counts, revision and shared text usage."
        ),
        ...errors,
      },
    },
