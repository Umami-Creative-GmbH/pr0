    ...
    get: {
      ...
      parameters: [
        ...
        },
        {
          ...
          schema: {
            type: "string",
            enum: ["all", "favorites", "archive", "collection"],
            default: "all",
          },
        },
        {
